...
function updateKPI() {
  ...
  document.getElementById("newCustomers").textContent =
    customers.filter(customer => customer.registered_type === "New").length;
  ...
  data.forEach(customer => {
    ...
    row.innerHTML = `
      <td>
        ...
        <span class="profile-sub">${customer.email}</span>
      </td>
...
function openCustomerForm(customerId = null) {
  ...
  detailForm.innerHTML = `
    ...
    <div class="form-group">
      <label>Email</label>
      <input name="email" value="${customer.email}" placeholder="Enter email" />
    </div>
    ...
    <div class="form-group">
      ...
      <select name="registered_type">
        <option value="New" ${customer.registered_type === "New" ? "selected" : ""}>New</option>
        <option value="Existing" ${customer.registered_type === "Existing" ? "selected" : ""}>Existing</option>
      </select>
    </div>
