 ...
 *   create_booking so the linked payment_history row & pricing stay correct.
 * - member_info / redemption / payment_history: READ-ONLY for the LLM.
...
export const TABLE_ALLOWLIST = {
  customers_profile: { idColumn: "customer_id", create: true, update: true, delete: true },
  pet_profiles: { idColumn: "pet_id", create: true, update: true, delete: true },
  staff: { idColumn: "staff_id", create: true, update: true, delete: true },
  coupon_type: { idColumn: "coupon_id", create: true, update: true, delete: true },
  leave_requests: { idColumn: "leave_id", create: true, update: true, delete: false },
  chat_messages: { idColumn: "message_id", create: true, update: false, delete: false },
  ...
  member_info: { idColumn: "loyalty_id", create: false, update: false, delete: false },
  redemption: { idColumn: "redemption_id", create: false, update: false, delete: false },
  payment_history: { idColumn: "payment_id", create: false, update: false, delete: false },
};
