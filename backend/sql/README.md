...
| `booking_conflict_prevention_migration.sql` | Atomic staff-overlap prevention, full-stay boarding room capacity/occupancy RPC, DAYCARE add-on persistence | ✅ conflict/occupancy base was verified live; re-run after this release for the DAYCARE add-on and full-duration conflict updates |
