...
--
-- Restored from ai-backend/supabase/migrations/002_add_document_id_to_chunks_bge_large.sql
-- (deleted when the AI backend moved to app/ + main.py at the project root).
-- Required by app/documents/vector_store.py's replace_document_chunks_bge_large
-- call — without this, POST /api/documents/process fails with a 503 pointing
-- back at this file.
--
-- Purpose:
